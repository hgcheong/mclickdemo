...
@RoutePage()
class ReportViewerQueryList extends BaseScreen {
  const ReportViewerQueryList({super.key});
 ...
 if (isPageDeniedView(AcxAuthAccess.pageDeniedList, wid)) {
    ...
    return CustomScrollView(slivers: [
      ...
      const SelectableText(
          "OLTP Rejected Transaction Query"),
      sbh20,
      const SelectableText(
        "Search",
      ),
                    ...
                    children: [
                      ...
                      const Row(
                        children: [
                          ...
                          Expanded(
                              child:
                                  FbNumber(label: 'Media No', name: 'MediaNo')),
                        ],
                      ),
                    ],
                  ),

...
class MyLineChart extends StatelessWidget {
  ...
  //   switch (value.toInt()) {
  //     case 2:
  //       text = const SelectableText('MAY', style: style);
  //       break;
  //     case 7:
  //       text = const SelectableText('JUNE', style: style);
  //       break;
  //     case 12:
  //       text = const SelectableText('JULY', style: style);
  //       break;
  //     default:
  //       text = const SelectableText('');
  //       break;
  //   }

...
@RoutePage()
class SubsidyList extends BaseScreen {
  const SubsidyList({super.key})
      : super(
 ...
 if (isPageDeniedView(AcxAuthAccess.pageDeniedList, wid)) {
  ...
  @override
  Widget sideBar() {
    return provideSideBar("subsidy/setup");
  }

  @override
  PreferredSizeWidget breadCrumb() {
    return provideBreadCrumb("subsidy/setup");
  }
}
            ...
            Expanded(
              child: SizedBox(
                  ...
                  child: AcxTrinaGridWithColumn(
                    spName: 'ApiPrgSubsList',
                    useNav: false,
                    querysql: '/sp/ApiPrgSubsList/queryasync',
                    params: const {},
                    idField: 'SubsId',
                    onNew: () {
                      ...
                      singleton<AppRouter>()
                          .navigatePath('/subsidy/program/new');
                    },
                    onSelectedTap: (TrinaRow val) {
                      singleton<AppRouter>().navigatePath(
                          '/subsidy/program/${val.cells['SubsId']!.value.toString()}');
                    },
                  )),
            )
          ],
